...
//            val msg = Msg("htdfservice/send", msgValue)
        ...
        //生成签名广播json
        @SuppressLint("NewApi")
        fun getSignTransaction(
            account_number: String,
            sequence: String,
            main: Boolean,
            key: ECKey,
            usdpTransaction: UsdpTransaction
        ): UsdpTransaction {
...
//            var msg = Gson().fromJson<MsgValue>(str, MsgValue::class.java)
            ...
            signJson.put("account_number", account_number)//账号id
            ...
            signJson.put("sequence", sequence)
            ...
            val pKey = PubKey(
                ...
                android.util.Base64.encodeToString(key.pubKey, android.util.Base64.DEFAULT)
            )
